...
export function getPackageGroups_ArchLinux() {
    const groupBase = new PackageGroup(
        ...
        ["base", "linux", "linux-firmware", "nano", "vi", "vim", "sudo", "networkmanager", "amd-ucode", "intel-ucode", "man-db", "man-pages", "texinfo", "openssh", "grub", "efibootmgr", "zsh", "fish", "fastfetch", "btop", "mkinitcpio", "iptables"],
        [repoCore, repoExtra],
        true,
        false
    )
